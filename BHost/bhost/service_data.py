...
app = Flask(__name__)
service_data = Blueprint('service_data',__name__)
...
def ErrorEncode(str):
	...
	return newStr;	
#获取数据分布data
@service_data.route('/get_service_data',methods=['GET','POST'])
def get_service_data():
    ...
    return '{"Result":true,"data":[{"value":10, "name":"SERVICE1"},{"value":5, "name":"SERVICE2"},{"value":15, "name":"SERVICE3"},{"value":10, "name":"SERVICE4"},{"value":15, "name":"SERVICE5"},{"value":25, "name":"SERVICE6"},{"value":20, "name":"SERVICE7"},{"value":35, "name":"SERVICE8"}]}'
